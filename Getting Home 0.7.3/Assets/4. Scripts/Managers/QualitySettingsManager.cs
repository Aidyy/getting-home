...
public class QualitySettingsManager : MonoBehaviour 
{
	...
	public ColorCorrectionCurves colourCorrection;
...
//	}
	...
	public void VignettingEnable()
	{
		vignetting.enabled = true;
	}
	public void VignettingDisable()
	{
		vignetting.enabled = false;
	}

	public void ColourCorrectionEnable()
	{
		colourCorrection.enabled = true;
	}
	public void dColourCorrectionDisable()
	{
		colourCorrection.enabled = false;
	}
	#endregion
	...
	{
		QualitySettings.maxQueuedFrames = 2; //2 queued frame
	}

	public void MaxedQueuedFramesSetting2Frames()
	{
		QualitySettings.maxQueuedFrames = 4; //4 queued frames
	}
	#endregion
}
